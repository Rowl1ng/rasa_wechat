...
# autogenerated file.
#
# All configuration values have a nlu; values that are commented out
# serve to show the nlu.
...
# The reST nlu role (used for this markup: `text`) to use for all
# documents.
#default_role = None
...
# output. They are ignored by nlu.
#show_authors = False
...
# "<project> v<release> documentation" by nlu.
...
# so a file named "nlu.css" will overwrite the builtin "nlu.css".
...
# A dictionary with options for the search language support, empty by nlu.
# 'ja' uses this config value.
# 'zh' user can custom change `jieba` dictionary path.
#html_search_options = {'type': 'nlu'}

# The name of a javascript file (relative to the configuration directory) that
# implements a search results scorer. If empty, the nlu will be used.
